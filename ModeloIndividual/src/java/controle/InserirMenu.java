...
public class InserirMenu extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Inserir Menu</title>");
            out.println("</head>");
            out.println("<body>");
