                                ...
                                <%
                                            ...
                                            try {
                                                ...
                                                if (u.getId()>0){
                                                    ...
                                                    <tr>
                                                        <td>ID:</td>
                                                        <td><%=u.getId() %> <input type="hidden" name="id" value="<%=u.getId() %>"> </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Perfil:</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>Nome:</td>
                                                        <td>
                                                            <input type="text" name="nome" value="<%=u.getNome() %>" size="60">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Login:</td>
                                                        <td><input type="text" name="login" value="<%=u.getLogin() %>"  size="30" /> </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Senha:</td>
                                                        <td><input type="password" name="senha" value="<%=u.getSenha() %>"  size="30" /> </td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
