                                            ...
                                            try {
                                                ...
                                                for(Menu m:lista){
                                                    ...
                                                    <tr align="center">
                                                        ...
                                                        <td><%=m.getLink() %></td>
                                                        <td><%=m.getIcone() %></td>
                                                        <td><a href="form_alterar_menu.jsp?id=<%=m.getId() %>"><img src="imagens/alterar.png"></a></td>
                                                        <td><a href="excluir_menu.do?id=<%=m.getId() %>"><img src="imagens/excluir.png" border="0"></a></td>
                                                    </tr>
                                                    <%
                                                }
                                                mDB.desconectar();
