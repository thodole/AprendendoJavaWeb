    ...
    <head>
        ...
        <script language="javascript" >
            function validaForm(){
                ...
                if(formulario.valorTotal.value === 0){
            ...
            <table>
                ...
                <tr>
                    <td width="760" height="100">
                        <div align="center">
                            <h2>PEDIDO PENDENTE DE PAGAMENTO</h2>
                            ...
                            <form name="formAlterarPagamento" action="alterarPagamento.do" method="post" onsubmit="return validaForm();">
                                <tr align="center">
                                    <td><%=pagamento.getValorTotal()%> <input type="hidden" name="idPagamento" value="<%=pagamento.getId() %>"></td>
                                    <td><%=pagamento.getValorPago() %> <input type="hidden" name="valorPago" value="<%=pagamento.getValorPago() %>"></td>
                                    <td><%=pagamento.getValorAPagar() %> <input type="hidden" name="valorAPagar" value="<%=pagamento.getValorAPagar() %>"></td>
                                    <td><input type="text" name="pagar" value="0" size="5"></td>
